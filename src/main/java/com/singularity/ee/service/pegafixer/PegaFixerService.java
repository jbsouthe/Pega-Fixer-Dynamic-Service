...
public class PegaFixerService implements IDynamicService {

    private AgentNodeProperties agentNodeProperties = new AgentNodeProperties();
    private static final IADLogger logger = ADLoggerFactory.getLogger((String)"com.singularity.dynamicservice.pegafixer.PegaFixerService");
    ...
    public PegaFixerService(AgentNodeProperties agentNodeProperties, long taskInitialDelay, long taskInterval) {
        this();
    ...
    private IAgentRunnable createTask(ServiceComponent serviceComponent) {
        ...
        return new PegaFixerTask( this, this.agentNodeProperties, serviceComponent, iServiceContext);
    }
